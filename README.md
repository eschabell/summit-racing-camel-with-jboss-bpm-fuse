...
-----------------------
1. Run the following from the bpms-fuse-travel-agency-integration-demo directory.

2. Add products to installs directory.

3. Run 'init.sh' or 'init.bat' file. 'init.bat' must be run with Administrative privileges.

4. Start the JBoss BPM Suite server, login, complete the brms-labs part of the workshop to complete the project. JBoss BPM Suite process project can be found at http://localhost:8080/business-central (u:erics/p:bpmsuite1!).
...
8. Complete the Fuse par of the workshop found in fuse-labs.

9. When all components in labs completed, build and deploy projects, run process to verify, see lab docs for more information.
